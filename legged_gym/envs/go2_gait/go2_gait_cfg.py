...
class Go2GaitCfg(LeggedRobotCfg):
    ...
    class foot_periodicity:
        ...
        calculate_from_slip_model = True # True
        ...
        init_foot_thetas_list = [
            [0, 0.5, 0.5, 0], # Trotting
            [0.0, 0.0, 0.5, 0.5], # bounding,
            [0.5, 0.5, 0.1, -0.1], # half-bounding
            [-0.1, 0.6, 0.1, 0.4] # Galloping
        ]
